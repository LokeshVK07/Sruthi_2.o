...
SCRAPER_STOP_AFTER_KNOWN_PAGES = max(1, int(_scraper_env("SCRAPER_STOP_AFTER_KNOWN_PAGES", "MASSTAMILAN_STOP_AFTER_KNOWN_PAGES", "2")))
SCRAPER_MOVIE_INDEX_STOP_AFTER_KNOWN_PAGES = max(
    1,
    int(_scraper_env("SCRAPER_MOVIE_INDEX_STOP_AFTER_KNOWN_PAGES", "MASSTAMILAN_MOVIE_INDEX_STOP_AFTER_KNOWN_PAGES", "120")),
)
